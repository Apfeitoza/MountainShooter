# Boa pratica para editar medidas somente em um local - variaveis de const sempre são em letras maiusculas

# C
import pygame

C_ORANGE = (255, 128, 0)
C_YELLOW = (255, 255, 120)
C_WHITE = (255, 255, 255)
C_GREEN = (0, 128, 0)
C_CYAN = (0, 128, 128)
...
PLAYER_KEY_SHOOT_MAC = {'Player1': (pygame.K_SPACE), 'Player2': pygame.K_LSHIFT}
